...
void FPS_Input::ResetMouseOffsets() {
    for (MouseState& state : _mouseStates) {
        state.xoffset = 0;
        state.yoffset = 0;
    }
...
int FPS_Input::GetMouseYOffset(int index) {
    if (index < 0 || index >= 4)
        return 0;
    else
...
bool FPS_Input::LeftMouseDown(int index) {
    if (index < 0 || index >= 4)
        return false;
    else
...
bool FPS_Input::RightMouseDown(int index) {
    if (index < 0 || index >= 4)
        return false;
    else
...
bool FPS_Input::LeftMousePressed(int index) {
    if (index < 0 || index >= 4)
        return false;
    else
...
bool FPS_Input::RightMousePressed(int index) {
    if (index < 0 || index >= 4)
        return false;
    else
...
int FPS_Input::GetMouseXOffset(int index) {
    if (index < 0 || index >= 4)
        return 0;
    else
...
bool FPS_Input::KeyDown(int keyboardIndex, int mouseIndex, unsigned int keycode) {
 

    // It's a keyboard button
    if (keyboardIndex >= 0 && keyboardIndex < 4) {
...
bool FPS_Input::KeyPressed(int keyboardIndex, int mouseIndex, unsigned int keycode) {
